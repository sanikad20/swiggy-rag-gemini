...
git clone https://github.com/sanikad20/swiggy-rag-gemini.git

cd swiggy-rag-gemini
...
The system generates answers **only from the retrieved document context**.
...
- The system depends on the **Google Gemini API free tier**
- If the API quota is exceeded, users may need to wait before retrying
- Answers are limited to the information available in the document
